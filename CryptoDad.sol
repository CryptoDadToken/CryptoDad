...
contract CryptoDad is ERC20, Ownable {
    uint256 public transactionFeeRate = 6; // 5% transaction fee on buy and sell
    address public marketingWallet = 0xB51AFa69E1Ee8F4d8d238CFb13162f9778841df9;
    mapping (address => bool) public _isWhiteListedFromFee;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    constructor() ERC20("Crypto Dad", "Crypto Dad") {
